...
import com.example.leafrecognizer.DebugTools;
import com.example.leafrecognizer.MathHelper;
import com.example.leafrecognizer.VectorComparator;
...
//        Core.multiply(contrastValueOfEachSuperpixel,new Scalar(255), contrastValueOfEachSuperpixel);
    ...
    public Bitmap createBitmapWithBoundary(Bitmap input){
        ...
        Log.d("DEBUG", "num. superpixel:  "  + superpixelsID.size());
